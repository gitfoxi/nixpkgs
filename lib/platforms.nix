...
rec {
  ...
  linux = ["i686-linux" "x86_64-linux" "armv5tel-linux" "armv6l-linux" "armv7l-linux" "mips64el-linux" "aarch64-linux" ];
  ...
  mesaPlatforms = ["i686-linux" "aarch64-linux" "x86_64-linux" "x86_64-darwin" "armv5tel-linux" "armv6l-linux" "armv7l-linux"];
